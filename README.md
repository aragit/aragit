...
| **Medical NLP** | **`bionlp-llama3-unsloth`**<br>Optimized Clinical NER Extraction Engine | LLaMA-3-8B, Unsloth, PEFT/LoRA, FastAPI | Utilizes Unsloth for highly memory-efficient PEFT/LoRA fine-tuning. Extracts multi-token clinical biomarkers and biomedical terms from unstructured EHR files with optimized inference latency for production environments. | [Active Repo]([https://github.com/aragit/bionlp-llama3-unsloth](https://github.com/aragit/bionlp-llama3-service/tree/main)) |
